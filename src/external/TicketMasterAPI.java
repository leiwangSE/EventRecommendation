...
public class TicketMasterAPI {
		...
		private static final String DEFAULT_KEYWORD = ""; // no restriction, no keywords
		private static final String API_KEY = "k8HCGZC7GWjwGlBWhCYq7wlx1PhZN6Md";
...
private Set<String> getCategories(JSONObject event) throws JSONException {
		...
		private List<Item> getItemList(JSONArray evernt) throws JSONException{
